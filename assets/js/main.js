(function($) {
    ...
    const translations = {
        ...
        es: {
            ...
            description: "Encuentra los mejores productos a excelentes precios."
        },
        fr: {
            title: "Bienvenue dans notre boutique",
            description: "Trouvez les meilleurs produits à des prix incroyables."
        },
        jp: {
            title: "私たちの店へようこそ",
            description: "最高の製品をお得な価格で見つけてください。"
        }
    };
